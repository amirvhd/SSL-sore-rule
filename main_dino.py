...
def get_args_parser():
    ...
    parser.add_argument('--center_momentum', default=0.85, type=float, help="momentum for teacher centring")
    parser.add_argument('--l', default=2.4, type=float, help="weight for second part of score loss ")
    ...
    parser.add_argument('--output_dir',
                        default="/dss/dssmcmlfs01/pn69za/pn69za-dss-0002/ra49bid2/dino_saved_models/score", type=str,
                        help="")
    ...
    for it, (images, _) in enumerate(metric_logger.log_every(data_loader, 10, header)):
        ...
        with torch.cuda.amp.autocast(fp16_scaler is not None):
            teacher_output = teacher(images[:2],
                                     epoch)  # only the 2 global views pass through the teacher
            # student_pred, \
            student_mean, student_var = student(images, epoch)
            loss, loss1, loss2 = scoreLoss(student_mean, student_var,
                                           teacher_output, epoch)
